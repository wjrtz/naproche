...
\begin{axiom}[Set Existence] $\emptyset$ is a set. \end{axiom}
...
\begin{axiom}[Powerset] Let $X$ be a set. Let $Y$ be a class such that
...
\begin{axiom}[Associativity]\label{Associativity}
   $(x +^{G} y) +^{G} z = x +^{G} (y +^{G} z)$ for all $x,y,z \in G$.
\end{axiom} 
...
\end{axiom}
\begin{axiom}[Distributivity]  Let $x,y,z \in R$.
...
Then $\neg 0^{R} \equiv_{S} 1^{R}$ mod $a$ within $R$.
\end{lemma}
...
\begin{axiom}[Summation recursion]\label{Summation_recursion}
...
%42
\begin{definition}[L 42] Assume that $B$ is a subset of $R$.
...
\begin{forthel}
%48
\begin{lemma}[L 48] Assume that $B$ is a subset of $R$.
...
%91
\begin{lemma}[L 91] Let $R$ be nonarchimedean and $B \subseteq R$.
...
\begin{lemma}[Boundedness of Singletons]
...
%337
\begin{lemma}[L 337] Let $R$ be nonarchimedean.
...
%365
\begin{lemma}[L 365] Let $R$ be nonarchimedean. Then
$R^o$ is a subgroup of $R$.
\end{lemma}

%371
\begin{lemma}[L 371] Let $R$ be nonarchimedean. Then
$R^o$ is a subring of $R$.
\end{lemma}


%380
\begin{definition}[ 380]
...
%30
\begin{definition}[L 30] Let $r$ be an element of $R$. $r$ is topologically
